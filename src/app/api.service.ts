...
export class ApiService {
  ...
  {
     return this._HttpClient.get(`https://api.themoviedb.org/3/trending/${Tv}/week?api_key=f8eeaa0f08e0e19cd33afb0e48afb235&page=${PageNumber}`)
  }
  GetTrendingMovies( PageNumber:number , movie:string ):Observable<any>
  {
     return this._HttpClient.get(`https://api.themoviedb.org/3/trending/${movie}/week?api_key=f8eeaa0f08e0e19cd33afb0e48afb235&page=${PageNumber}`)
  }
  ...
  {
     return this._HttpClient.get(`https://api.themoviedb.org/3/trending/${Person}/week?api_key=f8eeaa0f08e0e19cd33afb0e48afb235&page=${PageNumber}`)
  }
